    ...
    ***************************************************************************** */
    ...
    var Driver = /** @class */ (function (_super) {
        ...
        function Driver(testRunId, communicationUrls, runInfo, options) {
            ...
            _this.browserIdleUrl = communicationUrls.idle;
            ...
            _this.proxyless = options.proxyless;
        ...
        Driver.prototype._checkStatus = function () {
            ...
            return testcafeCore.browser
                .checkStatus(urls, hammerhead__default.createNativeXHR, { manualRedirect: true, proxyless: this.proxyless })
                .then(function (_a) {
