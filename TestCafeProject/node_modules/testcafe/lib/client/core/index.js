...
(function () {
    ...
    ***************************************************************************** */
    ...
    function proxylessCheckRedirecting(result, idlePageUrl) {
        var shouldStayOnIdle = result.cmd === COMMAND.idle
            && result.url === idlePageUrl
            && isCurrentLocation(idlePageUrl);
        var shouldGoToIdle = result.cmd === COMMAND.idle
            && result.url === idlePageUrl
    ...
    function getStatus(_a, createXHR, _b) {
        var statusUrl = _a.statusUrl, idlePageUrl = _a.idlePageUrl;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        result = _d.sent();
                        redirecting = proxyless ? proxylessCheckRedirecting(result, idlePageUrl) : regularCheckRedirecting(result);
